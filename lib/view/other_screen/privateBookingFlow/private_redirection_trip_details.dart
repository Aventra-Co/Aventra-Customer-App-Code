...
class PrivateRedirectionTripDetails extends StatefulWidget {
  static String routeName = './Details';
  final String tripId;
  const PrivateRedirectionTripDetails({super.key, required this.tripId});

  @override
  State<PrivateRedirectionTripDetails> createState() =>
      _RedirectionTripDetailsState();
}

class _RedirectionTripDetailsState
    extends State<PrivateRedirectionTripDetails> {
...
//======================date time validation==========
  dateTimeValidation(String enteredTickets) {
    ...
    if (selectedDate.isEmpty || selectedSlotIds.isEmpty) {
      ...
      return;
    } else if (tickets > availableTicketsCount) {
      SnackBarToastMessage.showSnackBar(context,
          "${AppLanguage.memberLimitMsg[language]} $availableTicketsCount");
      return;
    } else if (tickets <= 0) {
      SnackBarToastMessage.showSnackBar(
          context, AppLanguage.lessTicketMsg[language]);
      return;
    } else if (!isCheckBox) {
      SnackBarToastMessage.showSnackBar(
      ...
      if (tripDetails['addone'] == "NA") {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => PrivateBookingDetails(
              ...
              sendTicketsCount: enteredTickets,
      ...
      if (response.statusCode == 200) {
        ...
        if (res['success'] == true) {
          ...
          if (timeSlots.isNotEmpty) {
            availableTicketsCount = timeSlots[0]['available_ticket_count'];
            // SnackBarToastMessage.showSnackBar(
                                  ...
                                  calendarBuilders: CalendarBuilders(
                                    defaultBuilder: (context, day, focusedDay) {
                                      ...
                                      if (tripDateType == 1) {
                                        ...
                                        bool isFridayOrSaturday = day.weekday ==
                                                DateTime.friday ||
                                ...
                                children: [
                                  SizedBox(
                                    width: MediaQuery.of(context).size.width *
                                        ...
                                        100,
                                    child: Text(
                                      "${AppLanguage.totalCapacityText[language]} ($availableTicketsCount)",
                                      style: const TextStyle(
                                          color: AppColor.primaryColor,
                                          fontSize: 15,
                                          fontWeight: FontWeight.w600,
                              ...
                              AppButton(
                                ...
                                onPress: () {
                                  ...
                                  if (timeSlots.isEmpty) {
                                    SnackBarToastMessage.showSnackBar(
                                        context,
                                        AppLanguage.boatTimingNotAvailableText[
                                            language]);
                                  } else {
                                    dateTimeValidation(
