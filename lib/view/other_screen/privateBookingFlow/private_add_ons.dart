...
class PrivateAddOns extends StatefulWidget {
  static String routeName = './PrivateAddOns';
  ...
  const PrivateAddOns({
    ...
    required this.sendTicketsCount, required this.sendSlotIds, required this.allTimeSlots,
  });

  @override
  State<PrivateAddOns> createState() => PrivateAddOnsState();
}

class PrivateAddOnsState extends State<PrivateAddOns> {
