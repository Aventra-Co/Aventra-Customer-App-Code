...
class PrivateTripDetailsScreen extends StatefulWidget {
  ...
  final String tripId;
  const PrivateTripDetailsScreen({super.key, required this.tripId});

  @override
  State<PrivateTripDetailsScreen> createState() =>
      _PrivateTripDetailsScreenState();
}

class _PrivateTripDetailsScreenState extends State<PrivateTripDetailsScreen> {
                          ...
                          Column(
                            children: [
                              ...
                              CustomFormatterTextFormField(
                                ...
                                fillColorStatus: 0,
                                hintText:
                                    AppLanguage.enterMembersRequired[language],
