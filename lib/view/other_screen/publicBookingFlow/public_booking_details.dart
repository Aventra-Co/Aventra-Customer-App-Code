...
class PublicBookingDetails extends StatefulWidget {
  static String routeName = './PublicBookingDetails';
  ...
  @override
  State<PublicBookingDetails> createState() => _PublicBookingDetailsState();
}

class _PublicBookingDetailsState extends State<PublicBookingDetails> {
                                  ...
                                  defaultBuilder: (context, day, focusedDay) {
                                    ...
                                    if (tripDateType == 1) {
                                      ...
                                      shouldHighlight = isFridayOrSaturday &&
                                          !day.isBefore(DateTime.now().subtract(
                                              const Duration(days: 1)));
                                    }
