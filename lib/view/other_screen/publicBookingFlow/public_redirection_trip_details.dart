...
class PublicRedirectionTripDetails extends StatefulWidget {
  ...
  final String tripId;
  const PublicRedirectionTripDetails({super.key, required this.tripId});

  @override
  State<PublicRedirectionTripDetails> createState() =>
      _PublicRedirectionTripDetailsState();
}

class _PublicRedirectionTripDetailsState
    extends State<PublicRedirectionTripDetails> {
