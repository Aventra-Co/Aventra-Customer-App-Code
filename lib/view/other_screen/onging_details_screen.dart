...
import 'package:boatapp/chat/chat_screen.dart';
...
class OngoingDetailsScreen extends StatefulWidget {
  static String routeName = "./DetailsBeforeScreen";
  final String tripId;
  const OngoingDetailsScreen({super.key, required this.tripId});

  @override
  State<OngoingDetailsScreen> createState() => _OngoingDetailsScreen();
}

class _OngoingDetailsScreen extends State<OngoingDetailsScreen> {
